...
export const CONNECTOR_FIELDS: Record<string, ConnectorFieldDefinition[]> = {
  ...
  smtp: [
    ...
    },
    {
      ...
      placeholder: '587',
      required: true,
      helpText: 'SMTP server port (typically 587 for TLS, 465 for SSL)',
    },
    {
      key: 'smtpUser',
      label: 'SMTP Username',
    ...
    },
    {
      ...
      required: true,
      helpText: 'Your email password or app-specific password',
    },
    {
      key: 'smtpFrom',
      label: 'From Address',
  ...
  telegram: [
    ...
    },
    {
      ...
      required: false,
      helpText: 'Default chat/channel ID for messages (optional)',
    },
  ],
  discord: [
    {
      ...
      required: true,
      helpText: 'Create in Server Settings → Integrations → Webhooks',
    },
  ],
  whatsapp: [
    {
      ...
      required: true,
      helpText: 'From Meta for Developers WhatsApp Business API',
    },
    {
      key: 'whatsappPhoneId',
