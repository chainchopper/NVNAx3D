...
export class SettingsMenu extends LitElement {
  ...
  override render() {
    return html`
      ...
      <div
        class="menu-item group-ai"
        title="PersonI - Create and manage AI personas"
        role="button"
        tabindex="0"
      ...
      <div
        ...
        title="Tasks - Manage your to-do list"
        role="button"
        tabindex="0"
      ...
      <div
        class="menu-item group-productivity"
        title="Notes - Create and manage notes"
        role="button"
        tabindex="0"
      ...
      <div
        class="menu-item group-productivity"
        title="Routines - Automate tasks with IF-THEN-THAT"
        role="button"
        tabindex="0"
      ...
      <div
        ...
        role="button"
        tabindex="0"
        @click=${() => this.handleClick('connectors')}
        @keydown=${(e: KeyboardEvent) => this.handleKeydown(e, 'connectors')}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
